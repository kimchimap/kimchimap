...
def load_local_environment(root):
    allowed = {'POSTGRES_PASSWORD', 'MIGRATOR_PASSWORD', 'APP_PASSWORD', 'REDIS_PASSWORD', 'KAKAO_JAVASCRIPT_KEY', 'KAKAO_CLIENT_ID', 'KAKAO_CLIENT_SECRET', 'PUBLIC_DATA_SERVICE_KEY', 'PUBLIC_ORIGIN', 'JWT_PRIVATE_KEY_PATH', 'JWT_KEY_ID'}
