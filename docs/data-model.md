...
V1은 PostGIS 확장 존재를 검증한다. V2는 업소·외부 ID·scope·식재료·국가·법정/자발 표시 규칙·근거·불변 원산지 구성·철회·공개 포인터/이력·지정 테이블을 추가한다. 회원 이후의 모델은 후속 작업이다. 내부 ID는 UUID이며 외부 ID를 내부 PK로 쓰지 않는다. [결정](decisions/0005-origin-revisions.md)을 따른다.
