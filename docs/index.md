...
현재 작업: [카카오 로그인](plans/active/kakao-login.md), [로그인 결정](decisions/0008-kakao-login.md). 완료한 업소·원산지 모델은 [계획](plans/active/origin-model.md), [불변 기록 결정](decisions/0005-origin-revisions.md)을 참고한다.
